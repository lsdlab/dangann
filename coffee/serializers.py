...
class SpotsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Spot
        fields = ('id', 'city', 'name', 'longitude', 'latitude', 'download_speed', 'speed_test_link',
...
class CommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = ('id', 'comment_message', 'comment_user_name', 'comment_date', 'spot_id', 'comment_user_id', 'comment_mark')
