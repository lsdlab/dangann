...
urlpatterns = [
    ...
    url(r'^api/v1/city_spot_list_for_map/(?P<city>\w+)/$', views.city_spot_list_for_map, name="city_spot_list_for_map"),
    ...
    url(r'^api/v1/city_users/(?P<city>\w+)/$', views.city_users, name="city_users"),
    url(r'^api/v1/spot_users/(?P<pk>[0-9]+)/$', views.spot_users, name="spot_users"),
    url(r'^api/v1/latest_comments/$', views.latest_comments, name="latest_comments"),
]
