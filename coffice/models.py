...
class Spot(models.Model):
    ...
    download_speed = models.CharField(
        max_length=70, null=True, blank=True, default='')
    upload_speed = models.CharField(
        max_length=70, null=True, blank=True, default='')
    speed_test_link = models.URLField(
        max_length=100, null=True, blank=True, default='')
    price_indication = models.CharField(
        max_length=70, null=True, blank=True, default='')
    bathroom = models.BooleanField(default=False)

    commit_user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    commit_user_name = models.CharField(
        max_length=70, default='', null=True, blank=True)
...
class Comment(models.Model):
    ...
    comment_user = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    comment_user_name = models.CharField(
        max_length=70, default='', null=True, blank=True)
    comment_date = models.DateTimeField(default=timezone.now)

    comment_mark = models.CharField(
        max_length=10, default='comment', null=True, blank=True)
    comment_user_avatarurl = models.URLField(
